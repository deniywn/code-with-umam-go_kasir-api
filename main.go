...
var produk = []Produk{
	{ID: 1, Nama: "Minyak Goreng Tropical 1 Liter", Harga: 21990, Stok: 10},
	{ID: 2, Nama: "kecap", Harga: 12000, Stok: 20},
	{ID: 3, Nama: "Indomie Mi Instan Goreng 84 g", Harga: 3500, Stok: 100},
	{ID: 4, Nama: "Gas Tabung Melon", Harga: 23000, Stok: 10},
}

// Fungsi untuk GET /api/produk/{id}
...
// Fungsi untuk UPDATE /api/produk/{id}
...
// Fungsi untuk DELETE /api/produk/{id}
